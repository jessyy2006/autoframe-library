...
function Ue(t2) {
  ...
  if ((e2 = t2.length) && !(512 & n2)) {
    ...
    var s2 = e2 - (n2 = 512 & n2 ? 0 : -1), o2 = (Le != null ? Le : me)(s2, n2, t2, r2);
    ...
    for (s2 = e2 - 1; e2 > 0; s2 = e2 - 1) if (null == (a2 = t2[s2])) e2--, i2 = true;
      ...
      if (!((s2 -= n2) >= o2)) break;
      (r2 != null ? r2 : r2 = {})[s2] = a2, e2--, i2 = true;
    }
...
function rn(t2) {
  var _a2;
  if (W) return (_a2 = t2[$]) != null ? _a2 : t2[$] = /* @__PURE__ */ new Map();
  if ($ in t2) return t2[$];
...
function En(t2, e2) {
  var _a2;
  return (_a2 = ze(t2, e2)) != null ? _a2 : 0;
}
...
function Pr(t2, e2, n2, r2) {
  ...
  var s2 = r2[1];
  let o2 = 1;
  s2 && s2.constructor === Object && (i2.ga = s2, "function" == typeof (s2 = r2[++o2]) && (i2.la = true, Ir != null ? Ir : Ir = s2, Mr != null ? Mr : Mr = r2[o2 + 1], s2 = r2[o2 += 2]));
  const a2 = {};
...
var Is = class extends $n {
  ...
  g() {
    var _a2;
    return (_a2 = Jt(Ve(this, 2))) != null ? _a2 : false;
  }
};
...
function So(t2, e2 = -1, n2 = "") {
  return { categories: t2.map((t3) => {
    ...
    return { index: (_b = (_a2 = _n(t3, 1)) != null ? _a2 : 0) != null ? _b : -1, score: (_c2 = En(t3, 2)) != null ? _c2 : 0, categoryName: (_e2 = (_d = vn(t3, 3)) != null ? _d : "") != null ? _e2 : "", displayName: (_g = (_f = vn(t3, 4)) != null ? _f : "") != null ? _g : "" };
...
function xo(t2) {
  ...
  if ((e2 = (_d = hn(t2, cs, 4)) == null ? void 0 : _d.h()) && (s2.boundingBox = { originX: (_e2 = _n(e2, 1)) != null ? _e2 : 0, originY: (_f = _n(e2, 2)) != null ? _f : 0, width: (_g = _n(e2, 3)) != null ? _g : 0, height: (_h = _n(e2, 4)) != null ? _h : 0, angle: 0 }), (_i2 = hn(t2, cs, 4)) == null ? void 0 : _i2.g().length) for (const e3 of hn(t2, cs, 4).g()) s2.keypoints.push({ x: (_j = ze(e3, 1)) != null ? _j : 0, y: (_k = ze(e3, 2)) != null ? _k : 0, score: (_l = ze(e3, 4)) != null ? _l : 0, label: (_m = vn(e3, 3)) != null ? _m : "" });
  return s2;
}
function Lo(t2) {
  var _a2, _b, _c2, _d;
  const e2 = [];
  for (const n2 of ln(t2, ds, 1)) e2.push({ x: (_a2 = En(n2, 1)) != null ? _a2 : 0, y: (_b = En(n2, 2)) != null ? _b : 0, z: (_c2 = En(n2, 3)) != null ? _c2 : 0, visibility: (_d = En(n2, 4)) != null ? _d : 0 });
  return e2;
}
function Ro(t2) {
  var _a2, _b, _c2, _d;
  const e2 = [];
  for (const n2 of ln(t2, us, 1)) e2.push({ x: (_a2 = En(n2, 1)) != null ? _a2 : 0, y: (_b = En(n2, 2)) != null ? _b : 0, z: (_c2 = En(n2, 3)) != null ? _c2 : 0, visibility: (_d = En(n2, 4)) != null ? _d : 0 });
  return e2;
}
function Fo(t2) {
...
function sa(t2, e2, n2) {
  return ra(t2, e2), t2 = Qo(e2.createTexture(), "Failed to create texture"), e2.bindTexture(e2.TEXTURE_2D, t2), e2.texParameteri(e2.TEXTURE_2D, e2.TEXTURE_WRAP_S, e2.CLAMP_TO_EDGE), e2.texParameteri(e2.TEXTURE_2D, e2.TEXTURE_WRAP_T, e2.CLAMP_TO_EDGE), e2.texParameteri(e2.TEXTURE_2D, e2.TEXTURE_MIN_FILTER, n2 != null ? n2 : e2.LINEAR), e2.texParameteri(e2.TEXTURE_2D, e2.TEXTURE_MAG_FILTER, n2 != null ? n2 : e2.LINEAR), e2.bindTexture(e2.TEXTURE_2D, null), t2;
}
...
function Aa(t2) {
  return __spreadValues(__spreadProps(__spreadValues({}, Ta), { fillColor: (t2 = t2 || {}).color }), t2);
}
function ba(t2, e2) {
  ...
  configureAudio(t2, e2, n2, r2, i2) {
    this.i._configureAudio || console.warn('Attempting to use configureAudio without support for input audio. Is build dep ":gl_graph_runner_audio" missing?'), Go(this, r2 || "input_audio", (r3) => {
      Go(this, i2 = i2 || "audio_header", (i3) => {
        this.i._configureAudio(r3, i3, t2, e2 != null ? e2 : 0, n2);
      });
    });
  }
...
function Ka(t2, e2, n2, r2) {
  ...
  t2.g.oa(e2, t2.Z, r2 != null ? r2 : performance.now()), t2.finishProcessing();
}
...
var Za = class extends Ja {
  ...
  o(t2) {
    var _a2, _b;
    return "minDetectionConfidence" in t2 && An(this.h, 2, (_a2 = t2.minDetectionConfidence) != null ? _a2 : 0.5), "minSuppressionThreshold" in t2 && An(this.h, 3, (_b = t2.minSuppressionThreshold) != null ? _b : 0.3), this.l(t2);
  }
  D(t2, e2) {
...
var uc = class extends Ja {
  ...
  o(t2) {
    var _a2, _b, _c2, _d;
    return "numFaces" in t2 && Tn(this.s, 4, (_a2 = t2.numFaces) != null ? _a2 : 1), "minFaceDetectionConfidence" in t2 && An(this.s, 2, (_b = t2.minFaceDetectionConfidence) != null ? _b : 0.5), "minTrackingConfidence" in t2 && An(this.h, 4, (_c2 = t2.minTrackingConfidence) != null ? _c2 : 0.5), "minFacePresenceConfidence" in t2 && An(this.v, 2, (_d = t2.minFacePresenceConfidence) != null ? _d : 0.5), "outputFaceBlendshapes" in t2 && (this.outputFaceBlendshapes = !!t2.outputFaceBlendshapes), "outputFacialTransformationMatrixes" in t2 && (this.outputFacialTransformationMatrixes = !!t2.outputFacialTransformationMatrixes), this.l(t2);
  }
  D(t2, e2) {
  ...
  m() {
    ...
    Xi(n2, "mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph"), Hi(n2, "IMAGE:image_in"), Hi(n2, "NORM_RECT:norm_rect"), Wi(n2, "NORM_LANDMARKS:face_landmarks"), n2.o(e2), qi(t2, n2), this.g.attachProtoVectorListener("face_landmarks", (t3, e3) => {
      ...
      var _a2;
      if (this.outputFaceBlendshapes) for (const e4 of t3) t3 = ss(e4), this.j.faceBlendshapes.push(So((_a2 = t3.g()) != null ? _a2 : []));
      Yo(this, e3);
      ...
      if (this.outputFacialTransformationMatrixes) for (const e4 of t3) (t3 = hn(Ds(e4), ps, 2)) && this.j.facialTransformationMatrixes.push({ rows: (_b = (_a2 = _n(t3, 1)) != null ? _a2 : 0) != null ? _b : 0, columns: (_d = (_c2 = _n(t3, 2)) != null ? _c2 : 0) != null ? _d : 0, data: (_e2 = $e(t3, 3, qt, Ye()).slice()) != null ? _e2 : [] });
      Yo(this, e3);
...
var lc = class extends Ja {
  ...
  Ka(t2, e2, n2) {
    ...
    if (this.h = "function" == typeof e2 ? e2 : n2, Ya(this, t2, r2 != null ? r2 : {}), !this.h) return this.s;
  }
  m() {
    var t2 = new Qi();
...
function gc(t2, e2 = true) {
  ...
  for (const i2 of t2) {
    var r2 = ss(i2);
    t2 = [];
    for (const n3 of r2.g()) r2 = e2 && null != _n(n3, 1) ? (_a2 = _n(n3, 1)) != null ? _a2 : 0 : -1, t2.push({ score: (_b = En(n3, 2)) != null ? _b : 0, index: r2, categoryName: (_d = (_c2 = vn(n3, 3)) != null ? _c2 : "") != null ? _d : "", displayName: (_f = (_e2 = vn(n3, 4)) != null ? _e2 : "") != null ? _f : "" });
    n2.push(t2);
  }
  return n2;
}
var mc = class extends Ja {
  ...
  o(t2) {
    ...
    if (Tn(this.v, 3, (_a2 = t2.numHands) != null ? _a2 : 1), "minHandDetectionConfidence" in t2 && An(this.v, 2, (_b = t2.minHandDetectionConfidence) != null ? _b : 0.5), "minTrackingConfidence" in t2 && An(this.s, 4, (_c2 = t2.minTrackingConfidence) != null ? _c2 : 0.5), "minHandPresenceConfidence" in t2 && An(this.C, 2, (_d = t2.minHandPresenceConfidence) != null ? _d : 0.5), t2.cannedGesturesClassifierOptions) {
      var e2 = new Ws(), n2 = e2, r2 = ko(t2.cannedGesturesClassifierOptions, (_e2 = hn(this.h, Ws, 3)) == null ? void 0 : _e2.h());
      dn(n2, 0, 2, r2), dn(this.h, 0, 3, e2);
    } else void 0 === t2.cannedGesturesClassifierOptions && ((_f = hn(this.h, Ws, 3)) == null ? void 0 : _f.g());
    return t2.customGesturesClassifierOptions ? (dn(n2 = e2 = new Ws(), 0, 2, r2 = ko(t2.customGesturesClassifierOptions, (_g = hn(this.h, Ws, 4)) == null ? void 0 : _g.h())), dn(this.h, 0, 4, e2)) : void 0 === t2.customGesturesClassifierOptions && ((_h = hn(this.h, Ws, 4)) == null ? void 0 : _h.g()), this.l(t2);
  }
  Fa(t2, e2) {
  ...
  m() {
    ...
    Xi(n2, "mediapipe.tasks.vision.gesture_recognizer.GestureRecognizerGraph"), Hi(n2, "IMAGE:image_in"), Hi(n2, "NORM_RECT:norm_rect"), Wi(n2, "HAND_GESTURES:hand_gestures"), Wi(n2, "LANDMARKS:hand_landmarks"), Wi(n2, "WORLD_LANDMARKS:world_hand_landmarks"), Wi(n2, "HANDEDNESS:handedness"), n2.o(e2), qi(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      ...
      for (const e4 of t3) {
        t3 = fs(e4);
        const n3 = [];
        for (const e5 of ln(t3, ds, 1)) n3.push({ x: (_a2 = En(e5, 1)) != null ? _a2 : 0, y: (_b = En(e5, 2)) != null ? _b : 0, z: (_c2 = En(e5, 3)) != null ? _c2 : 0, visibility: (_d = En(e5, 4)) != null ? _d : 0 });
      ...
      for (const e4 of t3) {
        t3 = ls(e4);
        const n3 = [];
        for (const e5 of ln(t3, us, 1)) n3.push({ x: (_a2 = En(e5, 1)) != null ? _a2 : 0, y: (_b = En(e5, 2)) != null ? _b : 0, z: (_c2 = En(e5, 3)) != null ? _c2 : 0, visibility: (_d = En(e5, 4)) != null ? _d : 0 });
...
var _c = class extends Ja {
  ...
  o(t2) {
    var _a2, _b, _c2, _d;
    return "numHands" in t2 && Tn(this.j, 3, (_a2 = t2.numHands) != null ? _a2 : 1), "minHandDetectionConfidence" in t2 && An(this.j, 2, (_b = t2.minHandDetectionConfidence) != null ? _b : 0.5), "minTrackingConfidence" in t2 && An(this.h, 4, (_c2 = t2.minTrackingConfidence) != null ? _c2 : 0.5), "minHandPresenceConfidence" in t2 && An(this.s, 2, (_d = t2.minHandPresenceConfidence) != null ? _d : 0.5), this.l(t2);
  }
  D(t2, e2) {
  ...
  m() {
    ...
    Xi(n2, "mediapipe.tasks.vision.hand_landmarker.HandLandmarkerGraph"), Hi(n2, "IMAGE:image_in"), Hi(n2, "NORM_RECT:norm_rect"), Wi(n2, "LANDMARKS:hand_landmarks"), Wi(n2, "WORLD_LANDMARKS:world_hand_landmarks"), Wi(n2, "HANDEDNESS:handedness"), n2.o(e2), qi(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      ...
      for (const e4 of t3) {
        t3 = ss(e4);
        const n4 = [];
        for (const e5 of t3.g()) n4.push({ score: (_a2 = En(e5, 2)) != null ? _a2 : 0, index: (_c2 = (_b = _n(e5, 1)) != null ? _b : 0) != null ? _c2 : -1, categoryName: (_e2 = (_d = vn(e5, 3)) != null ? _d : "") != null ? _e2 : "", displayName: (_g = (_f = vn(e5, 4)) != null ? _f : "") != null ? _g : "" });
        i2.push(n4);
      }
...
var Ac = class extends Ja {
  ...
  o(t2) {
    var _a2, _b, _c2, _d, _e2, _f, _g;
    return "minFaceDetectionConfidence" in t2 && An(this.s, 2, (_a2 = t2.minFaceDetectionConfidence) != null ? _a2 : 0.5), "minFaceSuppressionThreshold" in t2 && An(this.s, 3, (_b = t2.minFaceSuppressionThreshold) != null ? _b : 0.3), "minFacePresenceConfidence" in t2 && An(this.H, 2, (_c2 = t2.minFacePresenceConfidence) != null ? _c2 : 0.5), "outputFaceBlendshapes" in t2 && (this.outputFaceBlendshapes = !!t2.outputFaceBlendshapes), "minPoseDetectionConfidence" in t2 && An(this.v, 2, (_d = t2.minPoseDetectionConfidence) != null ? _d : 0.5), "minPoseSuppressionThreshold" in t2 && An(this.v, 3, (_e2 = t2.minPoseSuppressionThreshold) != null ? _e2 : 0.3), "minPosePresenceConfidence" in t2 && An(this.L, 2, (_f = t2.minPosePresenceConfidence) != null ? _f : 0.5), "outputPoseSegmentationMasks" in t2 && (this.outputPoseSegmentationMasks = !!t2.outputPoseSegmentationMasks), "minHandLandmarksConfidence" in t2 && An(this.K, 2, (_g = t2.minHandLandmarksConfidence) != null ? _g : 0.5), this.l(t2);
  }
  D(t2, e2, n2) {
    const r2 = "function" != typeof e2 ? e2 : {};
  ...
  m() {
    ...
    Xi(r2, "mediapipe.tasks.vision.holistic_landmarker.HolisticLandmarkerGraph"), yn(r2, 8, xi, n2), Hi(r2, "IMAGE:input_frames_image"), Wi(r2, "POSE_LANDMARKS:pose_landmarks"), Wi(r2, "POSE_WORLD_LANDMARKS:pose_world_landmarks"), Wi(r2, "FACE_LANDMARKS:face_landmarks"), Wi(r2, "LEFT_HAND_LANDMARKS:left_hand_landmarks"), Wi(r2, "LEFT_HAND_WORLD_LANDMARKS:left_hand_world_landmarks"), Wi(r2, "RIGHT_HAND_LANDMARKS:right_hand_landmarks"), Wi(r2, "RIGHT_HAND_WORLD_LANDMARKS:right_hand_world_landmarks"), r2.o(e2), qi(t2, r2), $o(this, t2), this.g.attachProtoListener("pose_landmarks", (t3, e3) => {
      ...
      this.outputFaceBlendshapes && (t3 = ss(t3), n3.push(So((_a2 = t3.g()) != null ? _a2 : []))), Yo(this, e3);
    ...
    Xi(n2, "mediapipe.tasks.vision.image_classifier.ImageClassifierGraph"), Hi(n2, "IMAGE:input_image"), Hi(n2, "NORM_RECT:norm_rect"), Wi(n2, "CLASSIFICATIONS:classifications"), n2.o(e2), qi(t2, n2), this.g.attachProtoListener("classifications", (t3, e3) => {
      this.j = function(t4) {
        ...
        const e4 = { classifications: ln(t4, ys, 1).map((t5) => {
          var _a3, _b, _c2, _d;
          return So((_b = (_a3 = hn(t5, rs, 4)) == null ? void 0 : _a3.g()) != null ? _b : [], (_c2 = _n(t5, 2)) != null ? _c2 : 0, (_d = vn(t5, 3)) != null ? _d : "");
        }) };
        return null != he(Ve(t4, 2)) && (e4.timestampMs = (_a2 = he(Ve(t4, 2))) != null ? _a2 : 0), e4;
      }(_s(t3)), Yo(this, e3);
    ...
    Xi(n2, "mediapipe.tasks.vision.image_embedder.ImageEmbedderGraph"), Hi(n2, "IMAGE:image_in"), Hi(n2, "NORM_RECT:norm_rect"), Wi(n2, "EMBEDDINGS:embeddings_out"), n2.o(e2), qi(t2, n2), this.g.attachProtoListener("embeddings_out", (t3, e3) => {
      t3 = As(t3), this.embeddings = function(t4) {
        ...
        return { embeddings: ln(t4, ws, 1).map((t5) => {
          ...
          const e4 = { headIndex: (_b = (_a3 = _n(t5, 3)) != null ? _a3 : 0) != null ? _b : -1, headName: (_d = (_c2 = vn(t5, 4)) != null ? _c2 : "") != null ? _d : "" };
          if (void 0 !== cn(t5, vs, nn(t5, 1))) t5 = $e(t5 = hn(t5, vs, nn(t5, 1)), 1, qt, Ye()), e4.floatEmbedding = t5.slice();
          else {
            const n3 = new Uint8Array(0);
            e4.quantizedEmbedding = (_g = (_f = (_e2 = hn(t5, Es, nn(t5, 2))) == null ? void 0 : _e2.ma()) == null ? void 0 : _f.h()) != null ? _g : n3;
          }
          return e4;
        }), timestampMs: (_a2 = he(Ve(t4, 2))) != null ? _a2 : 0 };
      }(t3), Yo(this, e3);
...
var Rc = class extends Ja {
  ...
  o(t2) {
    var _a2, _b;
    return void 0 !== t2.displayNamesLocale ? He(this.h, 2, de(t2.displayNamesLocale)) : "displayNamesLocale" in t2 && He(this.h, 2), "outputCategoryMask" in t2 && (this.outputCategoryMask = (_a2 = t2.outputCategoryMask) != null ? _a2 : false), "outputConfidenceMasks" in t2 && (this.outputConfidenceMasks = (_b = t2.outputConfidenceMasks) != null ? _b : true), super.l(t2);
  }
  J() {
    !function(t2) {
      var _a2, _b, _c2;
      const e2 = ln(t2.ca(), zi, 1).filter((t3) => {
        var _a3;
        return ((_a3 = vn(t3, 1)) != null ? _a3 : "").includes("mediapipe.tasks.TensorsToSegmentationCalculator");
      });
      if (t2.s = [], e2.length > 1) throw Error("The graph has more than one mediapipe.tasks.TensorsToSegmentationCalculator.");
      1 === e2.length && ((_c2 = (_b = (_a2 = hn(e2[0], Gi, 7)) == null ? void 0 : _a2.l()) == null ? void 0 : _b.g()) != null ? _c2 : /* @__PURE__ */ new Map()).forEach((e3, n2) => {
        var _a3;
        t2.s[Number(n2)] = (_a3 = vn(e3, 1)) != null ? _a3 : "";
      });
    }(this);
  }
  segment(t2, e2, n2) {
...
var Kc = class extends Ja {
  ...
  o(t2) {
    var _a2, _b, _c2, _d, _e2;
    return "numPoses" in t2 && Tn(this.j, 4, (_a2 = t2.numPoses) != null ? _a2 : 1), "minPoseDetectionConfidence" in t2 && An(this.j, 2, (_b = t2.minPoseDetectionConfidence) != null ? _b : 0.5), "minTrackingConfidence" in t2 && An(this.h, 4, (_c2 = t2.minTrackingConfidence) != null ? _c2 : 0.5), "minPosePresenceConfidence" in t2 && An(this.v, 2, (_d = t2.minPosePresenceConfidence) != null ? _d : 0.5), "outputSegmentationMasks" in t2 && (this.outputSegmentationMasks = (_e2 = t2.outputSegmentationMasks) != null ? _e2 : false), this.l(t2);
  }
  D(t2, e2, n2) {
    const r2 = "function" != typeof e2 ? e2 : {};
...
function didPositionChange(newFace2, refFace2) {
  ...
  const zoomRatio = newFace2.width / refFace2.width;
  if (
    // if zoom/position changed a lot.
    Math.abs(newFace2.originX - refFace2.originX) > thresholdX || Math.abs(newFace2.originY - refFace2.originY) > thresholdY || Math.abs(1 - zoomRatio) > CONFIG.framing.percentZoomThreshold
  ) {
    return true;
  } else {
    return false;
